    ...
    <>
      ...
      {isMounted &&
        ...
        createPortal(
          ...
          >
            <Image
              src="https://portfolio.sherucon.me/work-cards/paranoyar/smiley.webp"
      ...
      <div className="flex flex-col md:flex-row h-[100dvh] w-screen overflow-hidden font-sans bg-[#161618]">
                  ...
                  <div className="flex justify-end gap-3">
                    {installStatus === "idle" ? (
                      <button
                        ...
                        className="bg-[#0066ff] text-white border-none px-4 py-2 rounded-md text-[13px] cursor-pointer relative overflow-hidden transition-colors hover:bg-[#005ce6] group animate-[ctaPulse_1.5s_infinite]"
                      >
        ...
        <div
          className={`order-1 md:order-2 ${showcaseMode ? "h-full md:flex-[1_0_100%] rounded-none" : "h-[30%] md:h-auto md:flex-1 rounded-[40px] border-[5px] border-[#161618] md:rounded-b-none md:border-[10px] md:rounded-[40px] z-20"} bg-white flex items-center justify-center relative [perspective:800px] shrink-0 transition-all duration-1000 ease-[cubic-bezier(0.2,0.8,0.2,1)] overflow-hidden`}
        ...
        >
          ...
          >
            ...
            <div
              ...
              style={{
                transform: `translateZ(40px) rotateX(${flipDegree}deg)`,
              }}
            >
              ...
              >
                <Image
                  ...
                  className={`w-auto xl:w-full h-auto object-contain drop-shadow-2xl transition-all duration-1000 ${
                    showcaseMode
                      ? "max-w-[90%] md:max-w-[60%] xl:max-w-[50%] max-h-[80vh] md:max-h-none"
              ...
              {!flipComplete && (
                ...
                >
                  <Image
                    src="https://portfolio.sherucon.me/work-cards/paranoyar/paranoid.webp"
