...
function AgentWindow({
  ...
  return (
    <div
      ref={containerRef}
      className={`flex-1 bg-[#161618] text-[#ededed] flex flex-col rounded-2xl overflow-hidden border border-[#333] h-[600px] relative transition-shadow duration-1000 ${cardShadowClass} ${isShaking ? "animate-[shake_0.4s_ease-in-out_2]" : ""}`}
    >
      <div className="flex-1 px-4 pt-6 pb-4 overflow-y-hidden flex flex-col gap-4 relative">
        {step >= 1 ? (
          <div className="shrink-0 flex justify-end md:animate-[slideUpFade_0.3s_ease_forwards]">
        ...
        {step >= 2 && (
          <div className="shrink-0 flex flex-col gap-2 md:animate-[slideUpFade_0.3s_ease_forwards]">
        ...
        {step >= 3 && (
          <div className="shrink-0 md:animate-[slideUpFade_0.3s_ease_forwards] mt-2">
            <div className="flex items-center gap-2 mb-2">
              <div
                className={`w-3 h-3 rounded-full ${bgMap[riskColor]} ${dotClass}`}
              ></div>
              <span className={`font-bold text-[14px] ${colorMap[riskColor]}`}>
                {riskLevel}
              </span>
            </div>
        ...
        {step >= 4 && (
          <div
            className={`shrink-0 bg-[#1e1e22] border border-[#333] rounded-xl overflow-hidden mt-3 md:animate-[slideUpFade_0.3s_ease_forwards] transition-shadow duration-700 ${terminalGlowClass}`}
          >
            ...
            <div className="p-4 font-mono text-[13px]">
              <div className="bg-[#111] p-3 rounded text-[#ddd] mb-4 border border-[#333] flex">
                ...
                <span className="text-[#ddd] whitespace-pre">
                  {typedCommand}
                  <span
                    className={`inline-block w-[7px] h-[14px] bg-[#888] ml-1 align-middle ${cursorBlinkClass}`}
                  ></span>
                </span>
              </div>
          ...
          <div className="text-[#888] text-[14px] min-h-[20px] flex items-center justify-between">
            <div>
              ...
              {step === 0 && typedPrompt.length < userPrompt.length && (
                <span
                  className={`inline-block w-[2px] h-[14px] align-middle bg-[#e0e0e0] ml-[2px] ${cursorBlinkClass}`}
                ></span>
              )}
            </div>
    ...
    <section className="w-full bg-[#f4f4f4] text-[#111] py-24 px-4 min-h-[100dvh] flex flex-col justify-center overflow-hidden">
      <div className="w-full max-w-[1400px] mx-auto">
        <h2 className="font-black text-5xl md:text-7xl tracking-tighter leading-none mb-16 uppercase text-center">
          The 3 Levels of <br />{" "}
          <span className="underline decoration-8 underline-offset-4">
            Paranoia
          </span>
        </h2>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 relative z-10">
          <AgentWindow
            ...
            bullets={
              <ul className="list-disc pl-4 marker:text-[#666] space-y-1">
                <li>
                  <strong className="text-white">Reads</strong> the system logs
            ...
            commandLine="cat /var/log/syslog"
            typingSpeed={20}
          ...
          <AgentWindow
            ...
            bullets={
              <ul className="list-disc pl-4 marker:text-[#666] space-y-1">
                <li>
                  <strong className="text-white">Downloads</strong> a package
                  from the internet.
                </li>
                <li>
                  <strong className="text-white">Modifies</strong> global system
                  state by installing a new binary.
                </li>
              </ul>
            }
          ...
          <AgentWindow
            ...
            bullets={
              <ul className="list-disc pl-4 marker:text-[#666] space-y-1">
                <li>
                  <strong className="text-white">Deletes</strong> files
                  permanently without recovery.
                </li>
                <li>
                  <strong className="text-white">Destructive action</strong>{" "}
                  that affects all users in this directory.
                </li>
              </ul>
            }
            commandPrompt="rm -rf ./*"
